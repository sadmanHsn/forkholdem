...
function convert(street, srcfolder, destfolder)
  ...
  for filebase, _ in pairs(goodfiles) do
    ...
    for player = 1, constants.players_count do
      ...
      local oldInputPath = path .. srcfolder .. inputname
      local oldTargetPath = path .. srcfolder .. targetname
      local newInputPath = path .. "moved-files/" .. inputname
      local newTargetPath = path .. "moved-files/" .. targetname
      os.rename(oldInputPath, newInputPath)
      os.rename(oldTargetPath, newTargetPath)
    end 
